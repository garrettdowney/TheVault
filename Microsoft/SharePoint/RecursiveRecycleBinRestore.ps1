...
$directoryToRestore = 'sites/sitename/Shared Documents'
...
$restoreSet = Get-PnPRecycleBinItem -FirstStage -RowLimit $maxRows | Where-Object {$_."Dirname" -Like $directoryToRestore + '/*' -or $_."Dirname" -Eq $directoryToRestore} and (DeletedByEmail -eq 'anobakht@qmpower.com') 
